    ...
    return (
        <div className="w-full max-w-[1440px] mx-auto px-[16px]">
            ...
            <div className="mt-[23px] flex flex-col mdl:grid mdl:grid-cols-2 2xl:grid-cols-3 gap-[16px]">
                ...
                <Link href="#" className="w-full border p-[20px] mdx:p-[25px] flex flex-col  min-h-[227px] mdx:min-h-[310px]  xl:min-h-[250px] xl:p-[15px] relative 2xl:col-span-2 bg-[#00863E] text-white col-span-2 last:col-span">
